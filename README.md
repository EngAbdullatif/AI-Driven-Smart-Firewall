...
│   ├── network\_diagram.png

│   └── packet\_tracer\_topology.pkt
Network Design
...
How It Works
iptables redirects network packets to an NFQUEUE.
The Python firewall engine receives each packet.
Scapy extracts packet-level features.
The Machine Learning model classifies the packet.
The firewall allows normal traffic and blocks suspicious traffic.
